...
Gem::Specification.new do |spec|
  spec.name          = "import-issues"
  spec.license       = "MIT"
  spec.version       = Import::Issues::VERSION
  spec.authors       = ["Jesse Newman"]
  spec.email         = ["newman.jesse@gmail.com"]

  spec.summary       = %q{Tool for importing cards from Trello into GitHub as issues.}
  spec.homepage      = "https://github.com/newmanships"
